...
class CursoController extends Controller
{
    ...
    {
        $searchAlumnoModel= new TrabajadorSearch();
        $dataAlumnoProvider= $searchAlumnoModel->searchByCompany(\Yii::$app->request->queryParams,$id);
        
        return $this->render('view', [
            'model' => $this->findModel($id),
            '$dataAlumnoProvider'=>$dataAlumnoProvider,
            '$searchAlumnoModel'=>$searchAlumnoModel,
