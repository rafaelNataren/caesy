...
$i= 0;
	...
	foreach ($MenuItems as $cate){
	    
	    $tallerItems = [];
	    $j = 0;
	    foreach ($cate->empresa as $tallerItem){
...
//	$categorias   = Categoria::findAll(['disponible'=>1]);
	$menuEmpresa = [];
	$a= 0;
	$menuEmpresa[$a]['label'] = 'Crear';
	$menuEmpresa[$a]['url'] = ['/empresa/create'];
	$menuEmpresa[$a]['icon'] = '<i class="fa fa-angle-double-right"></i>';
	$menuTalleres[$a++]['active'] = strpos(   $currentUrl   , 'empresa/create');
	
	
	$menuEmpresa[$a]['label'] = 'Ver todos';
	$menuEmpresa[$a]['url'] = ['/empresa/index'];
	$menuEmpresa[$a]['icon'] = '<i class="fa fa-angle-double-right"></i>';
	$menuEmpresa[$a++]['active'] = strpos(   $currentUrl   , 'empresa/index');
	
	
	foreach ($Empresas as $cate){
	    
	    
	    $menuEmpresa[$a]['label'] = $cate->nombre_empresa;
	    $menuEmpresa[$a]['url'] = ['/empresa/view','id'=>$cate->id_empresa];
	    $menuEmpresa[$a]['icon'] = '<i class="fa fa-eye"></i>';
	    $menuEmpresa[$a++]['active'] = strpos(   $currentUrl   , 'empresa/index');
	}
